...
function PermissionDialog({ isOpen, onConfirm, onCancel }) {
  const { t } = useLanguage();
        ...
        <>
          ...
          <div className="modal-center-wrapper">
            <motion.div
              ...
              aria-describedby="permission-message"
            >
              <h3 id="permission-title">{t("insufficientPermissionsTitle")}</h3>
              <p id="permission-message">
                {t("insufficientPermissionsMessage")}
              </p>
              <div
