...
const translations = {
  vi: {
    ...
    reviewThankYou: "Cảm ơn bạn!",
    reviewSuccessMessage: "Nhận xét của bạn đã được gửi thành công.",
    ...
    beFirstReview: "Hãy là người đầu tiên chia sẻ trải nghiệm của bạn!",
    loadingReviews: "Đang tải đánh giá...",
    reviewSubmitError: "Không thể gửi đánh giá. Vui lòng thử lại.",
    reviewFetchError: "Không thể tải đánh giá.",
    retry: "Thử lại",
    rating5: "Xuất sắc",
    rating4: "Tốt",
    rating3: "Bình thường",
    ...
    majorArcana: "Ẩn Chính (Major Arcana)",
    wands: "Gậy / Lửa (Wands)",
    cups: "Cốc / Nước (Cups)",
    swords: "Kiếm / Không Khí (Swords)",
    pentacles: "Tiền / Đất (Pentacles)",
    cardsCount: "{count} lá bài",
    clickCardInstruction: "Nhấp vào bất kỳ lá bài nào để xem ý nghĩa chi tiết và từ khóa.",
  },
  en: {
    // Header
    ...
    serviceCaution:
      "The author uses a free service, which may be interrupted due to high traffic. Thank you for your understanding.",
    freeUseDisclaimer:
      "This application is completely free to use for non-commercial purposes. Please credit the author if you share it elsewhere. The author does not accept donations and has no intention of monetizing this project. If you see this work being sold or used to ask for money elsewhere, it has been stolen. Please report it to me at <strong>minh.ngntri@gmail.com</strong>.",
    ...
    reviewFetchError: "Failed to load reviews.",
    retry: "Retry",
    rating5: "Excellent",
    rating4: "Good",
    rating3: "Okay",
    ...
    clickCardInstruction: "Click on any card to view its detailed meaning and keywords.",
  },
};
